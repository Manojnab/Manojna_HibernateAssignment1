...
public class App 
{
    ...
    public static void main( String[] args )
    {
    	...
    	/*Teacher teacher=new Teacher("manojna","B","manojna@gmail.com");
    	...
    	switch(choice) {
	    	case 1:System.out.println("below if the id of all the teachers with first names");
	    	getAllIdName();
	    			break;
	    	case 2:System.out.println("Enter the teacher data");
